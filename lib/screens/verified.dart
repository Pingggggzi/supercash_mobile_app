...
class IdVerified extends StatefulWidget {
  const IdVerified({Key? key}) : super(key: key);

  @override
  State<IdVerified> createState() => _IdVerifiedState();
}

class _IdVerifiedState extends State<IdVerified> {
  @override
